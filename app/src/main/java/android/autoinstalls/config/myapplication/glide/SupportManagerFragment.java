...
public class SupportManagerFragment extends Fragment {
    ...
    private final Set<SupportManagerFragment> childRequestManagerFragments = new HashSet<>();

    @Nullable
    private SupportManagerFragment rootRequestManagerFragment;
    ...
    private void addChildRequestManagerFragment(SupportManagerFragment child) {
        if(childRequestManagerFragments != null){
            childRequestManagerFragments.add(child);
        }
    }

    private void removeChildRequestManagerFragment(SupportManagerFragment child) {
    ...
    /**
     * Returns true if the fragment is a descendant(后代; 子孙; (由过去类似物发展来的) 派生物) of our parent.
     */
    ...
    private void registerFragmentWithRoot(
        ...
        rootRequestManagerFragment = LifecycleManager.getInstance().getSupportRequestManagerFragment(context, fragmentManager);
